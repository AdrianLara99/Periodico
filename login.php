  ...
  <div class="page">
    <div class="container">
      ...
      <div class="right">
        ...
        <form action="procesos/validar.php" method="post" class="form">
          <label for="correo">Correo</label>
          <input type="email" name="correo" id="email" required>
          <label for="pasword">Contraseña</label>
          <input type="password" name="pasword" id="pasword" required>
          <input type="submit" name="consultar" class="btn" id="submit"></input>
          <p class="boton-registrate">No tienes cuenta? -><a href="Registro.php">Registrate</a></p>
        </form>
      </div>
    </div>
  </div>
